...
export default function CustomerDetailClient({ customer, initialProjects }: CustomerDetailClientProps) {
  ...
  return (
    <div key={componentKey} className="min-h-screen bg-[#0A120A] relative overflow-hidden p-4 sm:p-6 animate-fade-in">
      ...
      <style jsx>{`
        ...
        @keyframes float-particle { 0% { transform: translateY(0) translateX(0); opacity: 0; } 10% { opacity: 0.3; } 90% { opacity: 0.2; } 100% { transform: translateY(-100px) translateX(50px); opacity: 0; } }
